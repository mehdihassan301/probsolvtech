...
const BlogPostPage: React.FC<{ id: string }> = ({ id }) => {
              ...
              <aside className="col-span-12 lg:col-span-4 mt-12 lg:mt-0">
                  <div className="sticky top-28 space-y-8">
                      <div>
                          ...
                          <div className="space-y-4">
                              {relatedPosts.map(related => (
                                  <Link key={related.id} href={`/blog/${related.id}`} className="group flex items-center space-x-4 text-left p-2 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 dark:focus-visible:ring-offset-bg_dark">
                                      <img src={related.image} alt={related.title} loading="lazy" className="w-20 h-20 sm:w-24 sm:h-24 object-cover rounded-lg flex-shrink-0" />
                                      <div>
                      ...
                      <div className="bg-primary/10 border border-primary/30 p-6 rounded-lg">
                          ...
                          <Link href="/contact" className="w-full px-5 py-2.5 bg-primary text-white font-semibold text-sm rounded-lg hover:bg-purple-600 flex items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white dark:focus-visible:ring-offset-primary/10">
