...
import { ChevronDownIcon, SparklesIcon, BrainIcon, UsersIcon, SpinnerIcon, ZapIcon } from '../components/Icons';
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Project costs vary depending on the scope, complexity, and technologies involved. Our starter websites begin around $500, while more complex apps and AI automations are custom-quoted. We provide detailed, transparent proposals after our initial consultation. Check out our Pricing page for more details.',
  },
  {
    question: 'How long will it take to build my website/app?',
    answer: 'Timelines depend on the project size. A simple landing page can be ready in as little as two weeks, a standard multi-page website typically takes 3 weeks, and complex applications or AI integrations can take a month. We always provide a project timeline with key milestones in our proposal.',
  },
  {
  ...
  },
  {
    ...
    answer: 'We understand that project requirements can evolve. We use an agile approach, which allows for flexibility. For significant changes, we\'ll discuss. Minor adjustments can often be accommodated within the existing sprint.',
  },
  {
    question: 'Do you provide domain and hosting services?',
    answer: 'While we don\'t directly provide domain registration or hosting, but our offers include those and we also offer guidance on the best providers for your needs (like Vercel, Hostinger, AWS, or Google Cloud). We handle the entire deployment process and can help you configure your domain and hosting environment for optimal performance and security.',
  },
  {
  ...
  },
  {
    ...
    answer: 'For most projects, we follow a milestone-based payment structure. Typically, this involves an upfront deposit to begin work (usually 20-50%), followed by payments upon completion of key milestones (e.g., design approval, feature completion). The final payment is due upon project completion and before the final handover.',
  },
  {
...
const useAnimateOnScroll = (ref: React.RefObject<HTMLElement | null>, threshold = 0.1) => {
      ...
      try {
        const response = await fetch('https://api.web3forms.com/submit', {
          ...
          body: JSON.stringify({ 
            ...
            message: question, 
            subject: 'About Page FAQ Question',
            from_name: 'ProbSolv FAQ Form'
          }),
        });
                  ...
                  <div className="bg-surface_light dark:bg-surface_dark border border-border_light dark:border-border_dark rounded-xl p-8">
                    ...
                    <form onSubmit={handleQuestionSubmit} className="space-y-4" noValidate>
                      ...
                      <button
                        ...
                        className="w-full px-6 py-3 bg-primary text-white font-semibold text-base rounded-lg hover:bg-purple-600 transition-colors duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus:ring-offset-2 dark:focus:ring-offset-surface_dark disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                      >
