              ...
              >
                <div className="grid md:grid-cols-5 gap-6 md:gap-8 items-center">
                  <div className="md:col-span-2">
                    <Link href={`/blog/${post.id}`} className="block w-full overflow-hidden rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 dark:focus-visible:ring-offset-bg_dark">
                  ...
                  <div className="md:col-span-3">
                    ...
                    <Link href={`/blog/${post.id}`} className="mt-4 inline-flex items-center font-semibold text-primary dark:text-accent focus:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded">
